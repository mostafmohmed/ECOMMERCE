                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.catugory.store')}}"
                                          method="POST"
                                            ...
                                            @if(get_languages() -> count() > 0)
                                                @foreach(get_languages() as $index => $lang)
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> اسم القسم - {{__('messages.'.$lang -> tt)}} </label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            {{-- <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="projectinput1">  أختصار اللغة {{__('messages.'.$lang ->tt)}}</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mt-1">
                                                                ...
                                                                <label for="switcheryColor4"
                                                                       class="card-title ml-1">الحالة  {{__('messages.'.$lang -> tt)}} </label>

                                                                @error("category.$index.active")
                                                                <span class="text-danger">ggggg </span>
                                                                @enderror
                                                            </div>
                                                        </div>
                                                    </div> 
